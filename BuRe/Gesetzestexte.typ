...
== ZGB
- *Art. 1 ZGB:* Anwendung des Rechts; Gesetz, Gewohnheitsrecht und richterliche Regelbildung.
- *Art. 2 ZGB:* Treu und Glauben; Verbot des Rechtsmissbrauchs.
- *Art. 3 ZGB:* Guter Glaube wird vermutet, solange Bösgläubigkeit nicht bewiesen ist.
- *Art. 4 ZGB:* Gerichtliches Ermessen; Entscheidung nach Recht und Billigkeit.
...
=== Wichtige Artikel aus dem Arbeitsrecht
- *Art. 319 ff. OR:* Einzelarbeitsvertrag.
- *Art. 320 OR:* Formfreier Abschluss des Arbeitsvertrags, auch mündlich oder konkludent.
- *Art. 321 OR:* Persönliche Arbeitspflicht des Arbeitnehmers.
- *Art. 321a OR:* Sorgfalts- und Treuepflicht, inkl. Geheimhaltung.
- *Art. 321c OR:* Überstundenarbeit.
- *Art. 321d OR:* Befolgung von Anordnungen und Weisungen.
- *Art. 321e OR:* Haftung des Arbeitnehmers aus Vertragsverletzung.
- *Art. 322 ff. OR:* Lohnpflicht des Arbeitgebers.
- *Art. 323 OR:* Fälligkeit und Auszahlung des Lohns.
- *Art. 324 ff. OR:* Lohn bei Verhinderung der Arbeitsleistung.
- *Art. 324a OR:* Lohnfortzahlung bei Verhinderung des Arbeitnehmers.
- *Art. 328 OR:* Schutz der Persönlichkeit, Gesundheit und Integrität des Arbeitnehmers.
- *Art. 330a OR:* Anspruch auf Arbeitszeugnis.
- *Art. 332 OR:* Rechte an Erfindungen und Designs.
- *Art. 334 OR:* Ende des befristeten Arbeitsvertrags durch Zeitablauf.
- *Art. 335 ff. OR:* Ordentliche Kündigung.
- *Art. 335b OR:* Kündigung während der Probezeit.
- *Art. 335c OR:* Gesetzliche Kündigungsfristen.
- *Art. 336 ff. OR:* Missbräuchliche Kündigung.
- *Art. 336c OR:* Kündigung zur Unzeit / Sperrfristen.
- *Art. 337 ff. OR:* Fristlose Kündigung aus wichtigem Grund.
- *Art. 337a OR:* Fristlose Kündigung bei Insolvenz des Arbeitgebers.
- *Art. 337c OR:* Folgen ungerechtfertigter fristloser Kündigung.
- *Art. 338 OR:* Tod des Arbeitnehmers.
- *Art. 340 ff. OR:* Konkurrenzverbot.
- *Art. 344a OR:* Lehrvertrag.
- *Art. 347a OR:* Handelsreisendenvertrag.
- *Art. 351a OR:* Heimarbeitsvertrag.
- *Art. 356c OR:* Schriftform des Gesamtarbeitsvertrags.
- *Art. 361 OR:* Absolut zwingende arbeitsrechtliche Bestimmungen.
- *Art. 362 OR:* Relativ zwingende arbeitsrechtliche Bestimmungen.
- *Art. 3 lit. d ArG:* Leitende Arbeitnehmer sind dem Arbeitsgesetz nicht unterstellt.
