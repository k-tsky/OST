...
== ZGB
Art. 8 ZGB = Wer muss was beweisen?\
Art. 4 ZGB = Gericht hat gesetzlichen Ermessensspielraum. (muss entscheiden)\
Art. 3 ZGB = Schützt den guten Glauben einer Person.\
Art. 2 ZGB = Verbietet treuwidriges Verhalten.

#table(
  columns: (4fr, 1.1fr, 2.5fr),
  inset: 6pt,
  align: (left, left, left),
  stroke: 0.5pt,

  [*Sachverhalt*], [*Art.*], [*Kurzbegründung*],

  [Roman kauft auf dem Parkplatz einer Raststätte von einer Privatperson drei Stangen Zigaretten zum halben Preis.],
  [Art. 3 ZGB],
  [Guter Glaube ist fraglich: Parkplatz, Privatperson und halber Preis hätten Roman misstrauisch machen müssen.],
  ...
  [Art. 4 ZGB],
  [Das Gesetz gibt dem Richter einen Rahmen. Innerhalb dieses Rahmens entscheidet er nach richterlichem Ermessen.],
  ...
  [Art. 2 Abs. 2 ZGB],
  [Das ist Rechtsmissbrauch. Die Kündigung ist zwar formal korrekt, wird aber zweckwidrig und schikanös eingesetzt.],
  ...
  [Art. 2 Abs. 1 ZGB],
  [Müller handelt gegen Treu und Glauben, weil er den Irrtum erkennt und bewusst schweigt.],

  [Maria behauptet, sie habe ihrem Freund Jonas 500 Franken geliehen. Jonas bestreitet dies.],
  [Art. 8 ZGB],
  [Maria muss beweisen, dass sie Jonas die CHF 500 geliehen hat.],
  ...
  [Art. 3 ZGB],
  [Da der Kauf in einem Second-Hand-Laden erfolgt und der Preis nicht extrem auffällig ist, könnte Tom gutgläubig gewesen sein.],
  ...
  [Art. 8 ZGB],
  [Es geht um Beweislast: Die Konsumentin muss den Mangel bzw. ihre Gewährleistungsansprüche beweisen.],
